...
def squared_sum_of_angles(points):
    ...
    """
    all_triples = [(points[i-2], points[i-1], points[i]) for i in range(len(points))]
...
def delta_squared_sum_of_angles(points, i, new_point):
    ...
    previous_points = [point_i_minus_two, point_i_minus_one, points[i], point_i_plus_one, point_i_plus_two]
    previous_point_triples = [(point_i_minus_two, point_i_minus_one, points[i]), (point_i_minus_one, points[i], point_i_plus_one), (points[i], point_i_plus_one, point_i_plus_two)]
    previous_angles = [angle(*triple) for triple in previous_point_triples]

    new_points = [point_i_minus_two, point_i_minus_one, new_point, point_i_plus_one, point_i_plus_two]
    new_point_triples = [(point_i_minus_two, point_i_minus_one, new_point), (point_i_minus_one, new_point, point_i_plus_one), (new_point, point_i_plus_one, point_i_plus_two)]
